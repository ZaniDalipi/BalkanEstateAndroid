...
interface MessagingRepository {
    ...
    suspend fun deleteConversation(conversationId: String): EmptyResult<DataError.Local>
    suspend fun archiveConversation(conversationId: String): EmptyResult<DataError.Local>
    suspend fun markAsRead(conversationId: String): EmptyResult<DataError.Local>
}
